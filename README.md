Post a color (only colors in the rainbow) to a Twitter account and the arduino will turn a LED that color. Inaddition the LCD attached to the arduino that will display the name of the color.
